...
description: REST API панели Daltoon-UI — аутентификация, входящие подключения, клиенты, статистика сервера и многое другое, сгенерировано из спецификации OpenAPI.
icon: Webhook
---

Панель Daltoon-UI предоставляет REST API для автоматизации. Эти страницы сгенерированы
