...
description: REST API панели D-UI — аутентификация, входящие подключения, клиенты, статистика сервера и многое другое, сгенерировано из спецификации OpenAPI.
icon: Webhook
---

Панель D-UI предоставляет REST API для автоматизации. Эти страницы сгенерированы
