---
title: База данных
description: Хранилища данных Daltoon-UI — SQLite (по умолчанию) и PostgreSQL — путь к базе данных, пул соединений и миграция с SQLite на PostgreSQL.
icon: Database
---

Daltoon-UI хранит всё — входящие подключения, клиентов, настройки — в базе данных.
