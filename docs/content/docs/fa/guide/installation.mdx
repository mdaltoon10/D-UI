---
title: نصب
description: نصب Daltoon-UI با اسکریپت رسمی (نسخهٔ پایدار، نسخهٔ مشخص یا dev-latest)، نصب خودکار/cloud-init یا Docker — و انتخاب میان SQLite و PostgreSQL.
icon: Download
---

‏Daltoon-UI روی طیف گسترده‌ای از توزیع‌های Linux اجرا می‌شود — Ubuntu، Debian، Armbian،
...
[صفحهٔ releases](https://github.com/mdaltoon10/Daltoon-UI/releases) دانلود کنید، آن را
...
دایرکتوری [`deploy/`](https://github.com/mdaltoon10/Daltoon-UI/tree/main/deploy) در مخزن
