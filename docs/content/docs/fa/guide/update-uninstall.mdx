...
description: مدیریت Daltoon-UI با منوی x-ui و خط فرمان — به‌روزرسانی (پایدار، dev یا نسخه‌های قدیمی)، تغییر تنظیمات و حذف تمیز و کامل.
icon: RefreshCw
---
...
| 6     | Uninstall                              | حذف Daltoon-UI (در ادامه ببینید)                                |
