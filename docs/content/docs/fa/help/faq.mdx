---
title: سؤالات متداول
description: پرسش‌های پرتکرار درباره Daltoon-UI — مجوز، سیستم‌های پشتیبانی‌شده، پایگاه‌های داده و کلاینت‌ها.
icon: CircleQuestionMark
---

## آیا Daltoon-UI رایگان و متن‌باز است؟

بله. Daltoon-UI تحت مجوز GPL-3.0 متن‌باز است. کد منبع آن روی
[GitHub](https://github.com/mdaltoon10/Daltoon-UI) در دسترس است.
...
## Daltoon-UI چه تفاوتی با x-ui دارد؟

Daltoon-UI یک فورک ارتقایافته از پروژه اصلی X-UI است. این پروژه پشتیبانی گسترده‌تری از
...
[صفحه نسخه‌ها](https://github.com/mdaltoon10/Daltoon-UI/releases) مراجعه کنید.

## از کجا می‌توانم کمک بگیرم؟

به کانال رسمی Telegram با نشانی [@mDaltoon](https://t.me/mDaltoon) برای
اطلاعیه‌ها و پشتیبانی انجمن بپیوندید، یا یک ایشو روی
[GitHub](https://github.com/mdaltoon10/Daltoon-UI/issues) باز کنید. برای مشکلات رایج، با
