---
title: مستندات Daltoon-UI
description: مستندات رسمی Daltoon-UI — یک پنل وب پیشرفته برای مدیریت سرورهای Xray-core، پروکسی‌ها، کلاینت‌ها و سابسکریپشن‌ها.
icon: House
---

**Daltoon-UI** یک پنل وب متن‌باز برای استقرار و مدیریت سرورهای
...
<Callout type="info">
  با Xray تازه آشنا شده‌اید؟ ابتدا [Daltoon-UI چیست؟](/docs/guide) را بخوانید — توضیح می‌دهد که پنل، Xray-core و
