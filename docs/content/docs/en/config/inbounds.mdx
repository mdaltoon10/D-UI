...
description: Create inbounds in Daltoon-UI — protocols, transports, traffic reset and expiry, and fallbacks that serve multiple protocols on one port.
...
inbound. In Daltoon-UI, fallbacks are managed in the panel (a master inbound's
