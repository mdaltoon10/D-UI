---
title: Database
description: Daltoon-UI storage backends — SQLite (default) and PostgreSQL — the database path, connection pool, and SQLite-to-PostgreSQL migration.
icon: Database
---

Daltoon-UI stores everything — inbounds, clients, settings — in a database. You choose
