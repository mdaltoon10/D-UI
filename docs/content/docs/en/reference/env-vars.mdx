...
description: Complete reference for Daltoon-UI's XUI_* environment variables — database, panel, logging, memory, and the tunnel health monitor.
icon: Variable
---

Daltoon-UI reads its runtime configuration from `XUI_*` environment variables. On a
