---
title: API Reference
description: The D-UI panel REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

The D-UI panel exposes a REST API for automation. These pages are generated from
