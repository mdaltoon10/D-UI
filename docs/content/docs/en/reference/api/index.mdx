---
title: API Reference
description: The Daltoon-UI panel REST API — authentication, inbounds, clients, server stats, and more, generated from the OpenAPI spec.
icon: Webhook
---

The Daltoon-UI panel exposes a REST API for automation. These pages are generated from
