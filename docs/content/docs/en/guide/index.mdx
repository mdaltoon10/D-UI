...
**Daltoon-UI** is a web control panel that sits on top of
...
<Mermaid
  chart={`
flowchart LR
  Admin["Admin browser"] -->|HTTPS panel| Panel["Daltoon-UI panel"]
...
Daltoon-UI is aimed at anyone running their own Xray server: from a single personal
...
<Callout type="info">
  Daltoon-UI is an enhanced fork of the original X-UI project, adding broader protocol
