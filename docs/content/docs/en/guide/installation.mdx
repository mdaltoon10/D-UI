---
title: Installation
description: Install Daltoon-UI via the official script (stable, pinned, or dev-latest), unattended/cloud-init, or Docker — and choose SQLite or PostgreSQL.
icon: Download
---

Daltoon-UI runs on a wide range of Linux distributions — Ubuntu, Debian, Armbian,
...
[releases page](https://github.com/mdaltoon10/Daltoon-UI/releases), extract it, and run
...
The repo's [`deploy/`](https://github.com/mdaltoon10/Daltoon-UI/tree/main/deploy)
