...
description: Manage Daltoon-UI with the x-ui menu and CLI — update (stable, dev, or legacy), change settings, and uninstall cleanly.
icon: RefreshCw
---
...
| 6     | Uninstall                              | Remove Daltoon-UI (see below)                                  |
