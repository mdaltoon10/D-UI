---
title: First Login
description: Find your generated Daltoon-UI credentials, reach the panel, enable two-factor auth, and harden it before exposing anything.
icon: KeyRound
---
...
Daltoon-UI supports TOTP two-factor auth (compatible with Google Authenticator, Aegis,
