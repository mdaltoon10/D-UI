---
title: First Login
description: Find your generated D-UI credentials, reach the panel, enable two-factor auth, and harden it before exposing anything.
icon: KeyRound
---
...
D-UI supports TOTP two-factor auth (compatible with Google Authenticator, Aegis,
