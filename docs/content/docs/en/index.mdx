---
title: Daltoon-UI Documentation
description: Official documentation for Daltoon-UI — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**Daltoon-UI** is an open-source web panel for deploying and managing
...
<Callout type="info">
  New to Xray? Read [What is Daltoon-UI?](/docs/guide) first — it explains how the panel, Xray-core, and
