---
title: D-UI Documentation
description: Official documentation for D-UI — an advanced web panel for managing Xray-core servers, proxies, clients, and subscriptions.
icon: House
---

**D-UI** is an open-source web panel for deploying and managing
...
<Callout type="info">
  New to Xray? Read [What is D-UI?](/docs/guide) first — it explains how the panel, Xray-core, and
