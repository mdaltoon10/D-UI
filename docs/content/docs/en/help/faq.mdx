---
title: FAQ
description: Frequently asked questions about Daltoon-UI — licensing, supported systems, databases, and clients.
icon: CircleQuestionMark
---

## Is Daltoon-UI free and open source?

Yes. Daltoon-UI is open source under the GPL-3.0 license. The source is on
[GitHub](https://github.com/mdaltoon10/Daltoon-UI).
...
## How is Daltoon-UI different from x-ui?

Daltoon-UI is an enhanced fork of the original X-UI project. It adds broader protocol
...
[releases page](https://github.com/mdaltoon10/Daltoon-UI/releases).

## Where can I get help?

Join the official Telegram channel [@mDaltoon](https://t.me/mDaltoon) for
announcements and community support, or open an issue on
[GitHub](https://github.com/mdaltoon10/Daltoon-UI/issues). For common problems, start
