---
title: FAQ
description: Frequently asked questions about D-UI — licensing, supported systems, databases, and clients.
icon: CircleQuestionMark
---

## Is D-UI free and open source?

Yes. D-UI is open source under the GPL-3.0 license. The source is on
...
## How is D-UI different from x-ui?

D-UI is an enhanced fork of the original X-UI project. It adds broader protocol
