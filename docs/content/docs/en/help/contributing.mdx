---
title: Contributing
description: How to contribute to D-UI and to translate this documentation.
icon: GitPullRequestArrow
---

D-UI is community-driven. Contributions to the panel and to these docs are
welcome.

## Support the developer

D-UI is free and open source, built and maintained in the open. If it's useful
