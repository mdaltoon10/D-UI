---
title: Contributing
description: How to contribute to Daltoon-UI and to translate this documentation.
icon: GitPullRequestArrow
---

Daltoon-UI is community-driven. Contributions to the panel and to these docs are
welcome.

## Support the developer

Daltoon-UI is free and open source, built and maintained in the open. If it's useful
to you, consider supporting continued development:

- **Donate** at [donate.sanaei.dev](https://www.buymeacoffee.com/mDaltoon) — the page shows
  current funding **goals and targets** you can help reach.
- **Star** the [repository](https://github.com/mdaltoon10/Daltoon-UI) and share the
  project.
- **Join** the Telegram channel [@mDaltoon](https://t.me/mDaltoon) to follow news and
  help others.

## Contribute to Daltoon-UI

- Read the project's `CONTRIBUTING.md` in the
  [repository](https://github.com/mdaltoon10/Daltoon-UI).
