---
title: Migration
description: Migrate to D-UI from x-ui, between servers, or between D-UI versions.
icon: ArrowRightLeft
---
...
<Step>
### Install D-UI on the new server
...
Importing an older x-ui panel's database directly into D-UI is **not
supported** — the schemas differ. Install D-UI fresh and recreate
