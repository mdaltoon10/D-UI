...
description: Fix common Daltoon-UI problems — the panel won't start, 502 errors, certificate issues, and clients that can't connect.
icon: Wrench
---
...
<Callout type="info">
  ...
  [GitHub issues](https://github.com/mdaltoon10/Daltoon-UI/issues) — your symptom has
