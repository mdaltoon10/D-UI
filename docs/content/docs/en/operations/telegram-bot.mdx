---
title: Telegram Bot
description: Connect a Telegram bot to Daltoon-UI for commands, periodic reports, event alerts (login, CPU, node up/down), backups, and client self-service.
icon: Send
---

Daltoon-UI can drive a Telegram bot for monitoring, alerts, backups, and remote
...
<Callout type="info">
  ...
  [@mDaltoon](https://t.me/mDaltoon). That's separate from the bot below, which you
