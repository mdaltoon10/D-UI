---
title: Security
description: Harden Daltoon-UI — panel auth and 2FA, Fail2ban IP limits, firewall rules, BBR, and staying current.
icon: ShieldCheck
---
...
Daltoon-UI installs and configures for you (enabled by default on script installs, and
...
Update Daltoon-UI and Xray-core regularly — security fixes land in new releases. Watch
the [releases page](https://github.com/mdaltoon10/Daltoon-UI/releases) and see
