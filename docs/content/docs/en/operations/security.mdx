---
title: Security
description: Harden D-UI — panel auth and 2FA, Fail2ban IP limits, firewall rules, BBR, and staying current.
icon: ShieldCheck
---
...
D-UI installs and configures for you (enabled by default on script installs, and
...
Update D-UI and Xray-core regularly — security fixes land in new releases. Watch
