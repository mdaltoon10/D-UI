...
// previous d-ui run and returns how many were killed.
//
// d-ui starts one mtg process per mtproto inbound outside its own lifecycle, and
...
// domain-fronted to the FakeTLS domain instead of proxied to Telegram. d-ui is
