...
export const SCHEMAS: Record<string, unknown> = {
  "AllSetting": {
    "description": "AllSetting contains all configuration settings for the d-ui panel including web server, Telegram bot, and subscription settings.",
    "properties": {
      "datepicker": {
      ...
      "ipLimitPolicy": {
        "description": "Policy for IP limit enforcement: kick_oldest or block_newest",
        "type": "string"
      },
      "ldapAutoCreate": {
        "type": "boolean"
  ...
  "Client": {
    ...
    "properties": {
      ...
      "createdBy": {
        "description": "Username of the ResellerAdmin who created it",
        "type": "string"
      },
      "created_at": {
  ...
  "Node": {
    "description": "Node represents a remote d-ui panel registered with the central panel.\nThe central panel polls each node's existing /panel/api/server/status\nendpoint over HTTP using the per-node ApiToken to populate the runtime\nstatus fields below.",
    "properties": {
      "activeCount": {
        "example": 23,
        "type": "integer"
  ...
  "Setting": {
    "description": "Setting stores key-value configuration settings for the d-ui panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
  ...
  "User": {
    "description": "User represents a user account in the d-ui panel.",
    "properties": {
      "id": {
        "type": "integer"
      },
