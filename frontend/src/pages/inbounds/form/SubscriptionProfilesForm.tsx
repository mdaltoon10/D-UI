    ...
    >
      ...
      {enabled && (
        <div style={{ marginTop: 12 }}>
                          ...
                          >
                            <div>
                              ...
                              <Input
                                value={prof.name}
                                onChange={(e) =>
                                  handleUpdateProfile(prof.id, { name: e.target.value })
                                }
                            ...
                            <div>
                              ...
                              <Input
                                value={prof.address}
                                onChange={(e) =>
                                  handleUpdateProfile(prof.id, { address: e.target.value })
                                }
                          ...
                          >
                            <div>
                              ...
                              <InputNumber
                                ...
                                value={prof.port}
                                onChange={(v) =>
                                  handleUpdateProfile(prof.id, { port: Number(v) || undefined })
                                }
                                placeholder="Port"
                              />
                            </div>
                          ...
                          <Collapse
                            ...
                            items={[
                                  ...
                                  >
                                    <div>
                                      ...
                                      <Input
                                        value={prof.path}
                                        onChange={(e) =>
                                          handleUpdateProfile(prof.id, { path: e.target.value })
                                        }
                                        placeholder="/path"
                                      />
                                    </div>
                                    <div>
                                      ...
                                      <Input
                                        value={prof.host}
                                        onChange={(e) =>
                                          handleUpdateProfile(prof.id, { host: e.target.value })
                                        }
                                ...
                                children: (
                                  <div>
                                    ...
                                    <Input
                                      value={prof.sni}
                                      onChange={(e) =>
                                        handleUpdateProfile(prof.id, { sni: e.target.value })
                                      }
                              ...
                              },
                              {
                                ...
                                children: (
                                  <Typography.Text type="secondary" style={{ fontSize: 12 }}>
                                    Custom headers, fingerprinting overrides, and extra subscription
                                    parameters.
                                  </Typography.Text>
                                ),
                              },
          ...
          <Button type="dashed" block icon={<PlusOutlined />} onClick={handleAddProfile}>
