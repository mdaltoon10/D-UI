...
export default function IndexPage() {
  ...
  function openTelegram() {
    window.open('https://t.me/mDaltoon', '_blank', 'noopener,noreferrer');
  }
                ...
                <Row gutter={[isMobile ? 8 : 16, 12]}>
                  ...
                  <Col xs={24} lg={12}>
                    <Card
                      ...
                      hoverable
                      actions={[
                        <Space className="action" key="tg" role="button" tabIndex={0} aria-label="@mDaltoon" onClick={openTelegram} onKeyDown={activateOnKey(openTelegram)}>
                          <TelegramFilled className="tg-icon" aria-hidden="true" />
                          {!isMobile && <span>@mDaltoon</span>}
                        </Space>,
                        <Space
                          key="panel-version"
