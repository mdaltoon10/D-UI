...
const AuthenticationPage = lazy(() => import('@/pages/admin/AuthenticationPage'));
...
const routes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: 'authentication', element: withSuspense(<AuthenticationPage />) },
      { path: 'panel/authentication', element: withSuspense(<AuthenticationPage />) },
