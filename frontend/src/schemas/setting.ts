...
export const AllSettingSchema = z.object({
  ...
  ipLimitPolicy: z.enum(['kick_oldest', 'block_newest']).optional(),
  ...
  subDaltoonTemplate: z.boolean().optional(),
  subShowGauges: z.boolean().optional(),
  subIranDirect: z.boolean().optional(),
  subIranRules: z.string().optional(),
